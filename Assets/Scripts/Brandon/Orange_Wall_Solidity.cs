...
public class Orange_Wall_Solidity : MonoBehaviour
{
    ...
    public MeshRenderer orange_wall_mesh; // The orange wall's mesh renderer.
    ...
    void Start()
    {
        // On start, the orange wall's box collider component is given to
        // the associated variable for access.
        ...
        // switches is stored into switch_center_object.
        ...
        shared_orange_wall_material = orange_wall_mesh.GetComponent<MeshRenderer>().sharedMaterial;
