...
public class Scene_Changer : MonoBehaviour
{
    ...
    void Start()
    {
        // On start, the scene changer object's box collider and mesh renderer components are
        // given to the associated variables for access, and the curren scene is stored.
