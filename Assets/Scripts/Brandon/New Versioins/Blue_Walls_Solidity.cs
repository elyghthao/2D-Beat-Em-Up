...
public class Blue_Walls_Solidity : MonoBehaviour
{
    ...
    private Renderer blue_wall_mesh; // The blue wall's mesh renderer.
    ...
    void Start()
    {
        // On start, the blue wall's box collider component is given to
